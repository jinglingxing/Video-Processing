...
function R = run_tracker(video, kernel_type, feature_type, show_visualization, show_plots)

	%path to the videos (you'll be able to choose one with the GUI).
% 	base_path = './data/Benchmark/';
    base_path = '/Users/jinlingxing/MATLAB/benchmark_tp3';
    %base_path ='/Users/jinlingxing/Documents/INF6803/lab/TP3/tp3_data/tp3';
	%default settings
...
%     padding = 2;  %extra area surrounding the target
	...
	case 'choose',
		...
		if ~isempty(video),
			...
			R = run_tracker(video, kernel_type, ...
				feature_type, show_visualization, show_plots);
	...
	otherwise
        ...
        save([res_path lower(video) '_kcf_' feature_type 'results.mat'], 'results');
            
        
        %%%%        
        p =transpose([1:1:1572]);
        r = [p, x-w/2,y-h/2, w, h];
        q = transpose([p, x-w/2,y-h/2, w, h]);
        fid = fopen('/Users/jinlingxing/MATLAB/benchmark_tp3/eee','w+');
